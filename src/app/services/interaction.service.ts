...
import { AlertController, LoadingController, ToastController } from '@ionic/angular'; // Sin standalone
...
export class InteractionService {
  ...
  private loading: HTMLIonLoadingElement | null = null; // Inicializado como null
  ...
  async dismissLoading() {
    ...
    this.loading = null; // Asigna null después de cerrar
  }
